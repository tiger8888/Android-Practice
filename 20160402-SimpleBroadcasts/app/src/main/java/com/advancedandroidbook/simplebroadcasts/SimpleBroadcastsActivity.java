...
public class SimpleBroadcastsActivity extends Activity {
    ...
    public void onClickBroadcastButton(View v) {
        Toast.makeText(SimpleBroadcastsActivity.this, "Broadcasting intent", Toast.LENGTH_SHORT).show();
        Intent intent = new Intent(ACTION_DANCE);
    ...
    public static class MyDancingBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Toast.makeText(context, "Get Down and Boogie!", Toast.LENGTH_LONG).show();
        }
    }
