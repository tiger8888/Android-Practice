...
public class ParenMatcherUnitTest extends ActivityTestCase {

    public void testHandleCursorChanged() {
        ParenMatcher parenMatcher = new ParenMatcher(new SpannableStringBuilder("xlabel('Time (sec)');"));
        ...
        parenMatcher = new ParenMatcher(new SpannableStringBuilder("axis([0 0.2 -1.2 1.2]);"));
        ...
        parenMatcher = new ParenMatcher(new SpannableStringBuilder("(([{[({[]})]}]))"));
